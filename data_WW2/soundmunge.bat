...
@call soundmungedir _BUILD\sound\worlds\WW2\%MUNGE_DIR% sound\worlds\WW2 sound\worlds\WW2\%MUNGE_PLATFORM% %MUNGE_PLATFORM% _BUILD _LVL_%MUNGE_PLATFORM%\sound _BUILD\sound WW2
